...
def historyReport(MaxAllowedOccurrences: int, MaxAllowedConsecLegs: int, MaxAllowedIntermittent: int, MaxAllowedConsecDays: int, ata: str, exclude_EqID:str, airline_operator: str, include_current_message: int, aircraft_no: str, fromDate: str , toDate: str):
    # if isValidParams(MaxAllowedOccurrences, MaxAllowedConsecLegs, MaxAllowedIntermittent, MaxAllowedConsecDays, ata, exclude_EqID, airline_operator, include_current_message, aircraft_no, fromDate, toDate):
    ...
    for i in range(len(notEmptyLabelPairs)):
        ...
        or ((flags_2in5 == equation).any() and check_2in5(dates)):
            ...
            MAINtable_array_temp[0,11] = max_intermittent.at[equation, float(aircraft)]
