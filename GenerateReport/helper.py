...
def connect_database_MDCdata(aircraft_no, ata, excl_eqid, airline_operator, include_current_message, from_dt, to_dt):
    MDCdataDF = ""
    airline_id = ""
    all_ata_str_list = []
